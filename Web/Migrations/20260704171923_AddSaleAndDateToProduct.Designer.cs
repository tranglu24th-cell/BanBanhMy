...
namespace Web.Migrations
{
    ...
    [Migration("20260704171923_AddSaleAndDateToProduct")]
    partial class AddSaleAndDateToProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ffb2aefc-12c4-46b3-86b5-a9b7a6169f71"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 5, 0, 19, 22, 412, DateTimeKind.Local).AddTicks(1143),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("fd48367d-f4a1-4e0b-a1f6-9d72afcebcc9"),
                            CreatedOn = new DateTime(2026, 7, 5, 0, 19, 22, 412, DateTimeKind.Local).AddTicks(1146),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("fd48367d-f4a1-4e0b-a1f6-9d72afcebcc9"),
                            CreatedOn = new DateTime(2026, 7, 5, 0, 19, 22, 412, DateTimeKind.Local).AddTicks(1149),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("fd48367d-f4a1-4e0b-a1f6-9d72afcebcc9"),
                            CreatedOn = new DateTime(2026, 7, 5, 0, 19, 22, 412, DateTimeKind.Local).AddTicks(1152),
                            Name = "Article",
                            ParentId = new Guid("5ea90800-ec76-4e3c-83f5-0d7446510385")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("fd48367d-f4a1-4e0b-a1f6-9d72afcebcc9"),
                            CreatedOn = new DateTime(2026, 7, 5, 0, 19, 22, 412, DateTimeKind.Local).AddTicks(1155),
                            Name = "Product",
                            ParentId = new Guid("5ea90800-ec76-4e3c-83f5-0d7446510385")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 5, 0, 19, 22, 412, DateTimeKind.Local).AddTicks(1095),
